    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-8 bg-stone" id="testimonials">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="elfsight-app-9cb63d08-d3ae-4650-a4e1-3c8fbf6a57d6" data-elfsight-app-lazy></div>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-8 bg-forest-dark text-cream">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-stone/50 mt-8 text-sm mb-10">Don&apos;t see your town? Shoot us a text — we may still be able to help.</p>
