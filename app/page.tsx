...
const GOOGLE_REVIEWS_HREF = "https://share.google/VG79kzggDENYQpd4c";
    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-8 bg-forest" id="gallery">
        <div className="max-w-6xl mx-auto">
          ...
          <Results />
          <p className="text-center text-stone/60 mt-10 text-base italic">
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-8 bg-stone" id="testimonials">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <a
            ...
            className="mt-10 inline-flex items-center gap-2 bg-white hover:bg-cream text-forest-dark font-bold px-6 py-3 rounded-full shadow-sm transition-colors"
          >
